...
## [Pipeline Code](./TranscriptomicsPipeline.html) `Complete code for Transcriptomics pipeline`  



## Type of data  (Brendan)  
  - Gene expression  
...
3. Functional consequences of methylation  
