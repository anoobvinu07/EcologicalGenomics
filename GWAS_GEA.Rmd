...
# beagle output for budset trait
ANGSD -GL 1 \
-out ${OUT}/ANGSD/beagle/bs/bs_beagle \
-nThreads 1 \
-doGlf 2 \
-doMajorMinor 1 \
-doMaf 1 \
-SNP_pval 1e-6 \
-bam ${OUT}/bam/all/bs_bam.list

# beagle output for growth ht trait
ANGSD -GL 1 \
-out ${OUT}/ANGSD/beagle/ht/ht_beagle \
-nThreads 1 \
-doGlf 2 \
-doMajorMinor 1 \
-doMaf 1 \
-SNP_pval 1e-6 \
-bam ${OUT}/bam/all/ht_bam.list
...
## PC ANGSD for budset beagle files 

python /data/popgen/pcangsd/pcangsd.py \
-beagle /data/project_data/GroupProjects/GWAS_env/ANGSD/beagle/bs/bs_beagle.beagle.gz \
-admix \
-o /data/project_data/GroupProjects/GWAS_env/PCA/pcangsd/bs_PC \
-threads 1

## PC ANGSD for ht beagle files 

python /data/popgen/pcangsd/pcangsd.py \
-beagle /data/project_data/GroupProjects/GWAS_env/ANGSD/beagle/ht/ht_beagle.beagle.gz \
-admix \
-o /data/project_data/GroupProjects/GWAS_env/PCA/pcangsd/ht_PC \
-threads 1

## PC ANGSD for all beagle files 

python /data/popgen/pcangsd/pcangsd.py \
-beagle /data/project_data/GroupProjects/GWAS_env/ANGSD/beagle/all/all_beagle.beagle.gz \
-admix \
...
-setMinDepth 3 \     # minimum total depth
-minInd 2 \          # use only sites with data from at least 2 individuals
-setMinDepthInd 1 \
-setMaxDepthInd 17 \
-skipTriallelic 1 \
